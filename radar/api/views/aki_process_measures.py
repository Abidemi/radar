...
from radar.api.serializers.aki_process_measures import (
...
class AkiProcessMeasureStatsRequestSerializer(serializers.Serializer):
...
class AkiProcessMeasureStatsView(ApiView):
    ...
    def get(self):
        args = parse_args(AkiProcessMeasureStatsRequestSerializer)
        group = args['group']
